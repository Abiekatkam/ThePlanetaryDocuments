...
import planet from "../assests/planet-jupiter.svg";
import internal from "../assests/planet-jupiter-internal.svg";
import geology from "../assests/geology-jupiter.png";

function ContentJupiter({ data }) {
  const HandleClicked = (e) => {
    e.preventDefault();
    document.getElementById("data14").classList.remove("hidden");
    document.getElementById("data13").classList.add("hidden");
    document.getElementById("data15").classList.add("hidden");
  };
  const HandleClicked2 = (e) => {
    e.preventDefault();
    document.getElementById("data14").classList.add("hidden");
    document.getElementById("data13").classList.remove("hidden");
    document.getElementById("data15").classList.remove("hidden");
  };
  ...
  return (
    <div
      ...
      id="pills-jupiter"
      role="tabpanel"
      aria-labelledby="jupiter"
      tabindex="0"
    >
      <div className="row g-lg-5 pt-0 pb-2 content">
        <div className="col-lg-7 text-center text-lg-center imgcontainer">
          <img src={planet} alt="alt" className="images img1" id="data13" />
          <img src={internal} alt="alt" className="images hidden" id="data14" />
          <img
            src={geology}
            alt="alt"
