...
import planet from "../assests/planet-mars.svg";
import internal from "../assests/planet-mars-internal.svg";
import geology from "../assests/geology-mars.png";

function ContentMars({ data }) {
  const HandleClicked = (e) => {
    e.preventDefault();
    document.getElementById("data10").classList.add("hidden");
    document.getElementById("data11").classList.remove("hidden");
    document.getElementById("data12").classList.add("hidden");
  };
  const HandleClicked2 = (e) => {
    e.preventDefault();
    document.getElementById("data10").classList.remove("hidden");
    document.getElementById("data11").classList.add("hidden");
    document.getElementById("data12").classList.remove("hidden");
  };
  ...
  return (
    <div
      ...
      id="pills-mars"
      role="tabpanel"
      aria-labelledby="mars"
      tabindex="0"
    >
      <div className="row g-lg-5 pt-0 pb-2 content">
        <div className="col-lg-7 text-center text-lg-center imgcontainer">
          <img src={planet} alt="alt" className="images img1" id="data10" />
          <img src={internal} alt="alt" className="images hidden" id="data11" />
          <img
            src={geology}
            alt="alt"
